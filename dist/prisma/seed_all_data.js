...
async function main() {
    ...
    copyFolderSync(path.join(websitePublicDir, 'images/categories'), path.join(backendUploadsDir, 'categories'));
    copyFolderSync(path.join(websitePublicDir, 'images/gifts'), path.join(backendUploadsDir, 'gifts'));
    ...
    copyFolderSync(path.join(websitePublicDir, 'images'), path.join(backendUploadsDir, 'products'));
    ...
    const admin = await prisma.admin.upsert({
        ...
        update: { password: hashedPassword, role: client_1.Role.SUPERADMIN },
        create: {
            name: 'Super Admin',
...
//# sourceMappingURL=seed_all_data.js.map